...
//     // auto cubeHandle2 = scene->CreateGameObject<TestCube>("cube2");
//     // cubeHandle2.gameObject->GetTransform()->Move(glm::vec3(5, 0, 0));
//     // auto cubeHandle3 = scene->CreateGameObject<TestCube>("cube3");
//     // cubeHandle3.gameObject->GetTransform()->Move(glm::vec3(-5, 0, 0));
...
//     // validCube = scene->FindGameObjectByName("cube2");
//     // if(validCube.gameObject)
//     //     ((TestCube*)validCube.gameObject)->meshComp->Draw(renderer);

//     // validCube = scene->FindGameObjectByName("cube3");
//     // if(validCube.gameObject)
//     //     ((TestCube*)validCube.gameObject)->meshComp->Draw(renderer);
